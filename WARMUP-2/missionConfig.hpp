...
{  
	class End1
	{
		...
		subtitle = "Day 06 | Bulldogs";
		description = "Excellent jobs with those ammo caches TWO SIERRA!";
	...
	class End2
	{
		...
		subtitle = "Day 06 | Bulldogs";
		description = "Those ammo caches needed to be destroyed. Mission Failed TWO SIERRA!";
		//pictureBackground = "Img\loadScreen_TwoSierra.jpg"; // eg. "img\yourpicture.jpg" no picture? use "";
		picture = "Img\logo_TwoSierra.paa"; // Marker icon
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
