...
// Obj Map markerAlpha
[_mmObjArray,	"mObj_3",600] call ADF_fnc_objectMarker;
[_mmObjArray,	"mDef_1",100] call ADF_fnc_objectMarker;
[_mmObjArray,	"mKearney",100] call ADF_fnc_objectMarker;

// Re-create critical markers
{[_x] call ADF_fnc_reMarker} forEach ["mMed_1","mObj_4"];