...
Corazol city - KEYHOLE<br/>
Corazol Mil. Base - CALVIN<br/>
POI Central Harbor - FOXTROT<br/>
POI MSR CP - ROMEO<br/>
POI North Harbor - GOLF<br/>
POI South Harbor - HOTEL<br/>
MSR Bridge West - DELTA<br/>
MSR Bridge East - ECHO<br/><br/>
...
<font color='#9DA698'>
CSAT 3RD QUDS have managed to secure Southern Sahrani in just under three days. Since then they have had ample time to dig-in, secure and fortify strategic POI and military sites.<br/><br/>
Intelligence indicates that CSAT has erected a double hedgehog perimeter around the city. Inbound roads and many buildings have been fortified. ACE has reported multiple AA-sites in the region. Therefore no CAS support for this op.<br/><br/>
ACE does not have a lot of actual intel on the AO. The weather has not permitted the use of aerial reconnaissance. Intel on the ground is scares at best. 4th VJTF Recon reported 20+ patrols in the Corazol region. No actionable intel on the city of Corazol.<br/><br/>
In order for NRF to carry out the assault on the Southern Island, we need full control of Corazol and its surrounding region. It is paramount that you succeed in capturing the city.
</font><br/><br/>
"]];
...
8. Execution of mission objectives to be briefed on site by PC.
...
<font color='#9DA698'>
2PLT will travel in SOP convoy to KEYHOL. 2PLT will divide the AO into sectors and secure KEYHOLE and the POI. 2PLT will establish OP at FOXTROL. 2 PLT will assault and secure CALVIN.
<br/><br/></font>
...
<font color='#9DA698'>
Primary: Assault and secure KEYHOLE.<br/>
Secondary: Assault and secure CALVIN.
</font><br/><br/>
"]];
...
<font color='#9DA698'>
1. JANE has taken control of all of the South Island, including the capital Corazol (KEYHOLE).<br/>
2. JANE M.O.B. is at Paraiso AB, support bases and FOB’s throughout the island.<br/>
3. JANE assets at KEYHOLE: 2 x inf coy, 1 x mech sqdr, plus various support elements.  1 x cav sqdr (MBT, AA), 1 x mech sqdr at CALVIN. <br/>
4. MPCOA: JANE has dug-in and fortified KEYHOLE. <br/>
5. JANE arms: Superior CSAT small arms incl. LRR sniper, thermal capability.<br/>
   AT capability: MPRL.<br/>
6. JANE CR: Superior CR. CSAT Special forces outfit with customized body armor.
<br/><br/></font>
...
<font color='#9DA698'>
1. Temperature High: 24C.<br/>
2. Temperature Low: 18C, Dew point: 17C.<br/>
3. Wind: Strong, 14-22 Knots.<br/>
4. Overcast, 12% chance of rain shower.
<br/><br/></font>
"]];
