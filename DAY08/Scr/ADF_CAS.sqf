...
ADF_CAS_targetDesc	= "victors, APC's, MBT's"; // Ingame decription of target (keep it short)
ADF_CAS_result		= "destroy"; // CAS requirements (interdict, destroy, area security, laser target, etc
