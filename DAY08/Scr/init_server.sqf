...
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "SERGEANT"]; _u moveInGunner sDiana_1;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "CORPORAL"]; _u moveInGunner sDiana_6;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "PRIVATE"]; _u moveInGunner sDiana_3;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "PRIVATE"]; _u moveInGunner sDiana_2;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "SERGEANT"]; _u moveInGunner sDiana_8;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "SERGEANT"]; _u moveInGunner sDiana_20;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mDiana", [], 0, "SERGEANT"]; _u moveInGunner sDiana_21;
