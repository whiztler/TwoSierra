...
["ACO","ACO","TWO SIERRA this is FAIRCHILD. Message. Over."] call ADF_fnc_MessageParser; sleep 8;
["2S","","FAIRCHILD this is TWO SIERRA. Send traffic. Over."] call ADF_fnc_MessageParser; sleep 8;
["ACO","ACO","TWO SIERRA this is FAIRCHILD. Get your defences in order as soon as possible. Break. ACE expects VLAD to commence its assault within the next 30 minutes. Break.<br/><br/>DONALD is securing DIANA and JANE. How copy?"] call ADF_fnc_MessageParser; sleep 22;
["2S","","FAIRCHILD this is TWO SIERRA. Solid copy on all. We'll be ready. Over."] call ADF_fnc_MessageParser; sleep 6;
["ACO","ACO","TWO SIERRA this is FAIRCHILD. Roger. Out."] call ADF_fnc_MessageParser;

ADF_msg_MBT = {
	["ACO","ACO","TWO SIERRA this is FAIRCHILD. Priority message. Over."] call ADF_fnc_MessageParser; sleep 8;
	["2S","","FAIRCHILD this is TWO SIERRA. Send traffic. Over."] call ADF_fnc_MessageParser; sleep 8;
	["ACO","ACO","TWO SIERRA this is FAIRCHILD. ACE is tracking 2 kings and several victors and APC's. Break. ETA 6 mikes. Over"] call ADF_fnc_MessageParser; sleep 18;
...
ADF_msg_INF = {
	...
	["ACO","ACO","TWO SIERRA this is FAIRCHILD. ACE is tracking 10 to 12 squads heading your way. Get ready! Over."] call ADF_fnc_MessageParser; sleep 19;
...
ADF_msg_sweep = {
	...
	["2S","","FAIRCHILD this is TWO SIERRA. Send traffic. Over."] call ADF_fnc_MessageParser; sleep 8;
	["ACO","ACO","TWO SIERRA this is FAIRCHILD. ACE reports the last remaining OPFOR are scattered around NOLA. Break. Do not let them retreat. Break. Mount up in your vehicles and clear and secure the area. How copy?"] call ADF_fnc_MessageParser; sleep 22;
...
ADF_msg_endMission = {
	if (time > 9000) then {
		...
		["2S","","FAIRCHILD this is TWO SIERRA. Send. Over."] call ADF_fnc_MessageParser; sleep 8;
		["ACO","ACO","TWO SIERRA this is FAIRCHILD MOTHER is pulling you out. Break. 4TH will finish up at NOLA. Break.<br/><br/>Head back to FARGO and pack up you gear. You're moving out to another hot zone tomorrow morning.<br/><br/>Good job TWO SIERRA. Out."] call ADF_fnc_MessageParser; sleep 25;
		...
		["ACO","ACO","TWO SIERRA is this is FAIRCHILD. Send traffic. Over."] call ADF_fnc_MessageParser; sleep 8;
		["2S","TWO SIERRA","FAIRCHILD this is TWO SIERRA. NOLA is blue and secured. How copy?"] call ADF_fnc_MessageParser; sleep 14;
		["ACO","ACO","TWO SIERRA this is FAIRCHILD. Solid copy. Break.<br/><br/>MOTHER is pulling you out. 4TH will take care of NOLA security. Break.<br/><br/>Head back to FARGO and pack up you gear. You're moving out to another hot zone tomorrow morning. Out."] call ADF_fnc_MessageParser; sleep 15;
		_l = ["tLayer"] call BIS_fnc_rscLayer; 
		_l cutText ["", "BLACK", 20];
		["<img size= '10' shadow='false' image='Img\intro_TwoSierra.paa'/><br/><br/><t size='.7' color='#FFFFFF'>Day 08 | Novi Disha</t>",0,0,9,8] spawn BIS_fnc_dynamicText;		
		['END1', true, 22] call BIS_fnc_endMission;	
