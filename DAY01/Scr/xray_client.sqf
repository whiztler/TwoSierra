if (hasInterface) then {
	...
	if (BearclawRescued) then {
		...
		hint parseText"<img size= '5' shadow='false' image='Img\ACO_logo.paa'/><br/><br/><t color='#6C7169' align='left'>FIRESTONE: Good job TWO SIERRA. Your next objective is to locate and secure BEARCLAW.<br/><br/></t>";
		_logTime = [dayTime] call BIS_fnc_timeToString;
		_logTimeText = "Log: " + _logTime;
