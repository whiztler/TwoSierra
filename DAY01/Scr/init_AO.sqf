...
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mCSAT_CP_1", [], 0,  "PRIVATE"]; _u moveInGunner vCSAT_CP_veh_1;
...
private ["_g", "_u"];
_g = createGroup independent; 
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mCSAT_CP_2", [], 0,  "PRIVATE"]; _u moveInGunner vCSAT_CP_veh_2;
...
private ["_g", "_u"];
_g = createGroup independent; 
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mCSAT_CP_3", [], 0,  "PRIVATE"]; _u moveInGunner vCSAT_CP_veh_3;
_u = _g createUnit ["I_Soldier_F", getMarkerPos "mCSAT_CP_3", [], 0,  "PRIVATE"]; _u moveInGunner vCSAT_CP_veh_4;
{[_x] call ADF_fnc_redressCSAT} forEach units _g;
...
[] spawn {
	...
	while {true} do {
		...
		private ["_c", "_v", "_wp", "_h", "_ps", "_pe"];
		_h	= ["O_h_Transport_04_F", "O_h_Transport_04_ammo_F", "O_h_Transport_04_bench_F", "O_h_Transport_04_box_F", "O_h_Transport_04_covered_F", "O_h_Transport_04_fuel_F", "O_h_Transport_04_medevac_F", "O_h_Transport_04_repair_F", "O_h_Light_02_unarmed_F", "O_h_Light_02_F"] call BIS_fnc_selectRandom;;			
		_ps	= ["mCSATair_1", "mCSATair_2", "mCSATair_3", "mCSATair_4", "mCSATair_5", "mCSATair_6", "mCSATair_7", "mCSATair_8"] call BIS_fnc_selectRandom;		
		_l	= [land_1, land_2, land_1, land_2] call BIS_fnc_selectRandom;		
		
		_c = createGroup independent;
		_v = [getMarkerPos _ps, 0, _h, _c] call BIS_fnc_spawnVehicle;
		{_x unassignItem "NVGoggles_OPFOR"; _x removeItem "NVGoggles_OPFOR"; _x enableGunlights "forceOn";} forEach units _c;
		v1 = _v select 0;
		_wp = _c addWaypoint [getPos _l, 0];
		...
		_pe = ["mCSATair_1", "mCSATair_2", "mCSATair_3", "mCSATair_4", "mCSATair_5", "mCSATair_6", "mCSATair_7", "mCSATair_8"] call BIS_fnc_selectRandom;
...
[] spawn {
	...
	while {true} do {
		...
		private ["_ps", "_pe", "_h", "_vc"];
		_ps	= ["mCSATair_1", "mCSATair_7", "mCSATair_8"] call BIS_fnc_selectRandom;
		_pe	= ["mCSATair_3", "mCSATair_4", "mCSATair_5"] call BIS_fnc_selectRandom;
		_h	= [30, 50, 150, 200, 250, 300, 350] call BIS_fnc_selectRandom;
		_vc	= ["O_Plane_CAS_02_F", "O_h_Attack_02_black_F", "O_h_Light_02_F"] call BIS_fnc_selectRandom;
		
		[getMarkerPos _ps, getMarkerPos _pe, _h, "FULL", _vc, EAST] call BIS_fnc_ambientFlyby; 		
		sleep 5;		
		[getMarkerPos _ps, getMarkerPos _pe, _h, "FULL", _vc, EAST] call BIS_fnc_ambientFlyby;
		sleep ([600, 1200, 2400, 3600] call BIS_fnc_selectRandom);
	};
};
...
private "_a";
_a = ["mGuerVeh_30", "mGuerVeh_31", "mGuerVeh_32", "mGuerVeh_33", "mGuerVeh_34", "mGuerVeh_35"];
...
[] spawn { // CSAT switch side random timer
	private ["_t"];
	_t	= 60 * ([45, 60, 75, 90, 105, 120] call BIS_fnc_selectRandom);
	
	waitUntil {sleep 10; time > _t};
