...
if (hasInterface) then {
	//if (ADF_isHC || isServer) exitWith {}; // HC exits, local testing
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\6SQDR_logo.paa'/><br/><br/>	<t color='#6C7169' align='left'>Lt. McDevon: TWO SIERRA this is RAPTOR. Standing by with OSCAR. Out.</t><br/><br/>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Two Sierra Log", [_logTimeText,"<br/><br/><font color='#9da698' size='14'>From: RAPTOR</font><br/><font color='#9da698' size='14'>Time: " + _logTime + "</font><br/><br/><font color='#6c7169'>------------------------------------------------------------------------------------------</font><br/><br/><font color='#6C7169'>Lt. McDevon: TWO SIERRA this is RAPTOR. Standing by with OSCAR. Out.</font><br/><br/>"]];	
