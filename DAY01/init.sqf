...
if (isServer) then {diag_log "ADF RPT: Init - executing init.sqf"}; // Reporting. Do NOT edit/remove
...
if (hasInterface) then {call compile preprocessFileLineNumbers "Core\f\ADF_fnc_presets.sqf";};
