...
Example for scripted groups:
[_spawnPos, PatrolPos, WEST, 1, FALSE, 300, 5, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_createFootPatrol;
[getMarkerPos "myMarker", getMarkerPos "PatrolMarker", EAST, 2, FALSE, 500, 6, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_createFootPatrol;
